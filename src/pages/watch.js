                        ...
                        .then(body => {
                            ...
                            if (data) {
                                ...
                                if (data.rocket.first_stage.cores && data.rocket.first_stage.cores[0].reused) {
                                    $badges.innerHTML += `<a class="chip tooltipped"><img src="/assets/reuse.png">Reused booster</a>`
                                }
                                if (data.rocket.second_stage.payloads && data.rocket.second_stage.payloads[0].reused) {
                                    $badges.innerHTML += `<a class="chip tooltipped"><img src="/assets/reuse.png">Reused capsule</a>`
								}
